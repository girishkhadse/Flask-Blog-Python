...
with open('/Users/Girish/Desktop/Projects/Flask-tut/config.json', 'r') as c:
...
class Contacts(db.Model):
    # take parameters from database table --> Contacts
...
class Posts(db.Model):
    # take parameters from database table -->posts
    sno = db.Column(db.Integer, primary_key=True)
...
def contact():
    if(request.method == "POST"):
        ...
        entry = Contacts(name=name, phone_num=phone,
                         mes=message, date=datetime.now(), email=email)
